...
from marketagents.agents.utils.agent_states import AgentState
from marketagents.agents.utils.agent_utils import Toolkit
...
class GraphSetup:
    ...
    def setup_graph(
        ...
        research_manager_node = create_research_manager(
            self.deep_thinking_llm, self.research_manager_memory
        )
